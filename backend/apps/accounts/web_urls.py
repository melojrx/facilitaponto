...
from .web_views import (
    ...
    signup_view,
    solicitations_index_view,
    solicitation_adjustments_view,
    time_clock_detail_view,
    time_clock_list_view,
    treatment_point_list_view,
    treatment_point_mirror_view,
...
urlpatterns = [
    ...
    path("painel/tratamento-ponto/<int:employee_id>/espelho/", treatment_point_mirror_view, name="tratamento_ponto_espelho"),
    path(
    ...
    path("painel/solicitacoes/", solicitations_index_view, name="solicitacoes"),
    path("painel/solicitacoes/ajustes/", solicitation_adjustments_view, name="solicitacoes_ajustes"),
